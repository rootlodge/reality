...
__export(client_exports, {
  ...
  useRealityClient: () => useRealityClient
});
...
function useRealityClient(options) {
...
function useReality(topic, clientOverride) {
  ...
  const [events, setEvents] = (0, import_react.useState)(() => client.getEvents(topic));
